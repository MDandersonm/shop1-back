...
import com.example.shop1back.config.jwt.JwtProperties;
...
public class CorsConfig {
   ...
   public CorsFilter corsFilter() {
      ...
      config.addAllowedOrigin("http://localhost:8887"); // e.g. http://domain1.com 어디에서든지 다 허용  // 모든 ip에 응답을 허용하겠다.
      ...
      source.registerCorsConfiguration("/**", config);// /**로 들어오는 요청은 이 config 설정을 따르라는 말
