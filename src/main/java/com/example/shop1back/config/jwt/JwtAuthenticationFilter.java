...
//			}
			...
			System.out.println("로그인 완료됨 Authentication : "+principalDetailis.getUser().getEmail());
...
//		System.out.println("principalDetailis.getAttributes()"+principalDetailis.getAttributes());
//		System.out.println("principalDetailis.getAuthorities()"+principalDetailis.getAuthorities());
//		System.out.println("principalDetailis.getName()"+principalDetailis.getName());
		//RSA방식은 아니고 Hash암호방식
		String jwtToken = JWT.create()
				.withSubject(principalDetailis.getUser().getEmail())
