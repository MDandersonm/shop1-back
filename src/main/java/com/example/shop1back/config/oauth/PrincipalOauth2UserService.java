package com.example.shop1back.config.oauth;
...
import com.example.shop1back.config.oauth.provider.FaceBookUserInfo;
import com.example.shop1back.config.oauth.provider.GoogleUserInfo;
import com.example.shop1back.config.oauth.provider.NaverUserInfo;
import com.example.shop1back.config.oauth.provider.OAuth2UserInfo;
	...
	*/
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		if(userRequest.getClientRegistration().getRegistrationId().equals("google")) {
			...
			System.out.println("우리는 구글과 페이스북 , 네이버 만 지원합니다.");
		}
